...
export const ja: Translations = {
  ...
  about: {
    title: "音典ウェブ版について",
    intro:
      "漢字音典（Yindian）は、漢字の読みを包括的に収集したデータベースです。Maigoが制作したMCPDictを起源とし、最も早い漢字読み検索ツールの一つです。",
    history:
      "その後、多くの専門家が協力し、大量の漢字読みデータを継続的に収集・整理し、漢字音典アプリを制作しました。nk2028は漢字音典アプリを基に音典ウェブ版を公開し、より多くのユーザーが異なる時代や地域の漢字発音を便利に検索できるようにしました。現在、音典ウェブ版は千余種類の言語変種を収録し、上古音、中古音、近代音、現代の各地方言をカバーしています。",
    features: "主な機能",
